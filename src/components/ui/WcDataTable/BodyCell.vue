<template>
  ...
  >
    ...
    <component
      ...
      :index="rowIndex"
      :frozen-row="frozenRow"
      :editor-init-callback="editorInitCallback"
    />
    <component
      ...
      :index="rowIndex"
      :frozen-row="frozenRow"
      :editor-save-callback="editorSaveCallback"
      :editor-cancel-callback="editorCancelCallback"
    />
    <component
      :is="column.children.body"
      v-else-if="
    ...
    <template v-else-if="columnProp('expander')">
      <button class="p-row-toggler p-link" type="button" @click="toggleRow">
        <span :class="rowTogglerIcon" />
      </button>
    </template>
    <template v-else-if="editMode === 'row' && columnProp('rowEditor')">
      <button
        ...
        @click="onRowEditInit"
      >
        <span class="p-row-editor-init-icon pi pi-fw pi-pencil" />
      </button>
      <button
        v-if="d_editing"
        ...
        @click="onRowEditSave"
      >
        <span class="p-row-editor-save-icon pi pi-fw pi-check" />
      </button>
      <button
        v-if="d_editing"
      ...
      >
        <span class="p-row-editor-cancel-icon pi pi-fw pi-times" />
      </button>
    </template>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      containerStyle() {
        const bodyStyle = this.columnProp('bodyStyle');
      ...
      loadingOptions() {
        const getLoaderOptions =
          this.getVirtualScrollerProp('getLoaderOptions');
        return (
          getLoaderOptions &&
