...
<!--    >-->
<!--      <span class="pi pi-filter-icon pi-filter" />-->
<!--    </button>-->
<!--    <button-->
...
<!--                {{ matchMode.label }}-->
<!--              </li>-->
<!--              <li class="p-column-filter-separator" />-->
<!--              <li-->
<!--                class="p-column-filter-row-item"-->
<!--                @click="clearFilter()"-->
<!--                @keydown="onRowMatchModeKeyDown($event)"-->
...
<!--                  :options="matchModes"-->
<!--                  :model-value="fieldConstraint.matchMode"-->
<!--                  option-label="label"-->
<!--                  option-value="value"-->
...
<!--      isShowMatchModes() {-->
<!--        return (-->
<!--          this.type !== 'boolean' && this.showMatchModes && this.matchModes-->
<!--        );-->
<!--      },-->
<!--      operatorOptions() {-->
<!--        return [-->
...
<!--      fieldConstraints() {-->
<!--        return (-->
<!--          this.filters[this.field].constraints || [this.filters[this.field]]-->
<!--        );-->
<!--      },-->
<!--      showRemoveIcon() {-->
...
<!--        const fieldFilters = this.filters[this.field];-->
...
<!--          const fieldFilter = this.filtersStore[this.field];-->
<!--          if (fieldFilter) {-->
...
<!--      addConstraint() {-->
<!--        const _filters = { ...this.filters };-->
<!--        const newConstraint = { value: null, matchMode: this.defaultMatchMode };-->
...
<!--        const _filters = { ...this.filters };-->
<!--        const removedConstraint = _filters[this.field].constraints.splice(-->
<!--          index,-->
<!--          1,-->
<!--        );-->
...
<!--        if (prevItem)-->
<!--          DomHandler.hasClass(prevItem, 'p-column-filter-separator')-->
...
<!--        return (-->
<!--          this.$refs.icon &&-->
<!--          (this.$refs.icon.isSameNode(target) ||-->
<!--            this.$refs.icon.contains(target))-->
<!--        );-->
<!--      },-->
