      ...
      >
        ...
        >
          <td :colspan="columnsLength - 1">
            ...
            >
              <span :class="rowGroupTogglerIcon(rowData)" />
            </button>
            <component
        ...
        >
          ...
          >
            <BodyCell
              ...
              :editing-meta="editingMeta"
              :virtual-scroller-content-props="virtualScrollerContentProps"
  ...
  export default {
    ...
    watch: {
      virtualScrollerContentProps(newValue, oldValue) {
        if (
          ...
          this.getVirtualScrollerProp('itemSize', oldValue) !==
            this.getVirtualScrollerProp('itemSize', newValue)
        ) {
    ...
    methods: {
      ...
      updateVirtualScrollerPosition() {
        ...
        this.$el.style.top =
          (this.$el.style.top || 0) + tableHeaderHeight + 'px';
      },
