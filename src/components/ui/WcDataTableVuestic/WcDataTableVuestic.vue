...
<!--    :color="loadingColor"-->
<!--  >-->
<!--    <table class="va-data-table__table" v-bind="computedTableAttributes">-->
...
<!--            :aria-label="-->
<!--              column.sortable ? `sort column by ${column.label}` : undefined-->
<!--            "-->
...
<!--                <va-icon-->
<!--                  :name="-->
<!--                    sortingOrderSync === 'asc' ? 'expand_less' : 'expand_more'-->
<!--                  "-->
<!--                  size="small"-->
<!--                  class="va-data-table__table-th-sorting-icon"-->
<!--                  :class="{-->
<!--                    active:-->
<!--                      sortBySync === column.name && sortingOrderSync !== null,-->
<!--                  }"-->
<!--                />-->
<!--              </div>-->
<!--            </div>-->
...
<!--      <tbody class="va-data-table__table-tbody" :style="rowCSSVariables">-->
<!--        <slot name="bodyPrepend" />-->

<!--        <transition-group :name="animationName" appear>-->
...
<!--            :title="column.thTitle"-->
<!--            :aria-label="-->
<!--              allowFooterSorting && column.sortable-->
<!--                ? `sort column by ${column.label}`-->
<!--                : undefined-->
<!--            "-->
<!--            class="va-data-table__table-th"-->
<!--            :class="getClass(column.thClass)"-->
...
<!--            @click.exact="-->
<!--              allowFooterSorting && column.sortable && toggleSorting(column)-->
<!--            "-->
<!--            @keydown.enter.stop="-->
<!--              allowFooterSorting && column.sortable && toggleSorting(column)-->
<!--            "-->
...
<!--        default: () => [] as DataTableColumnSource[],-->
<!--      },-->
<!--      items: {-->
<!--        type: Array as PropType<DataTableItem[]>,-->
<!--        default: () => [] as DataTableItem[],-->
<!--      },-->
<!--      itemsTrackBy: {-->
<!--        type: [String, Function] as PropType<-->
<!--          string | ((item: DataTableItem) => any)-->
<!--        >,-->
<!--        default: '',-->
<!--      },-->
<!--      modelValue: {-->
<!--        type: Array as PropType<(DataTableItem | DataTableItemKey)[]>,-->
<!--      }, // selectedItems-->
...
<!--      selectMode: {-->
<!--        type: String as PropType<DataTableSelectMode>,-->
<!--        default: 'multiple',-->
<!--      },-->
...
<!--      const { sortBySync, sortingOrderSync, toggleSorting, sortedRows } =-->
...
<!--                  props.stickyHeader || props.stickyFooter,-->
<!--              },-->
...
<!--      const getColumnAriaSortOrder = (columnName: string) =>-->
<!--        sortingOrderSync.value && sortBySync.value === columnName-->
...
<!--          &:nth-child(2n) {-->
<!--            &:not(.selected) {-->
<!--              @include va-background(-->
<!--                var(&#45;&#45;va-data-table-striped-tr-background-color),-->
<!--                var(&#45;&#45;va-data-table-striped&#45;&#45;tr-opacity),-->
<!--                -1-->
<!--              );-->
<!--            }-->
<!--          }-->
