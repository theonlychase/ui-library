...
//   const isDifferentRowLength = computed(
//     () => rows.value.length !== oldRowsLength.value,
//   );
//
//   watch(rows, (newRows) => {
//     const animationType =
//       isDifferentRowLength.value || newRows.length > 50 ? 'fade' : 'shuffle';
//
//     animationName.value = props.animated
//       ? `table-transition-${animationType}`
//       : '';
//
